...
canvas = tk.Tk()
canvas.title("Namit Music Player")
canvas.geometry("600x800")
canvas.config(bg= 'Black')

rootpath = "D:\\Projects\Online Music App\music"
pattern = "*.mp3"
...
listBox = tk.Listbox(canvas, fg = "Light Blue", bg = "Black", width = 100, font = ('ds-digit',))
listBox.pack(padx = 15, pady = 15)
label = tk.Label(canvas, text ='',bg = 'black', fg = 'yellow', font=('ds-digit',18))
label.pack(pady = 15)
